...
// extras que podem ser feitos:
// adicionar ponteiro para o ultimo elemento da lista
void MoveToTop(struct List *pList, int Index);  // musica no index 'i' passa a ser a primeira
void MoveToLast(struct List *pList, int Index);  // musica no index 'i' passa a ser a ultima
