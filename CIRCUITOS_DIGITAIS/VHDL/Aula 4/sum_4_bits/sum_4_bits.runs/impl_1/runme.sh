...
HD_PWD='C:/Users/169050/Desktop/VHDL/Aula 4/sum_4_bits/sum_4_bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum.tcl -notrace
