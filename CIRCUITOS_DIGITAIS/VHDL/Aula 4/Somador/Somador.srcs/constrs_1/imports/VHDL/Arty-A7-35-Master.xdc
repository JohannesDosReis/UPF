...
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { cin }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { cout }]; #IO_25_35 Sch=led[5]
