...
HD_PWD='C:/Users/169050/Desktop/VHDL/Aula 2/Decodificador/Decodificador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dec.tcl -notrace
