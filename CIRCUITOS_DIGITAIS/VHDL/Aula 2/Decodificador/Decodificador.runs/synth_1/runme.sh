...
HD_PWD='C:/Users/169050/Desktop/VHDL/Aula 2/Decodificador/Decodificador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dec.tcl
