...
HD_PWD='C:/Users/169050/Desktop/VHDL/Aula 3/Decodificador_7_SEG/Decodificador_7_SEG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec_7_SEG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dec_7_SEG.tcl -notrace
