...
HD_PWD='C:/Users/Johannes/Desktop/VHDL/Aula 5/Alarme de Carro/Alarme de Carro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alarme_carro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alarme_carro.tcl -notrace
