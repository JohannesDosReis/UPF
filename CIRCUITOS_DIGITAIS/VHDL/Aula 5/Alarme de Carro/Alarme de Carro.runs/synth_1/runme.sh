...
HD_PWD='C:/Users/Johannes/Desktop/VHDL/Aula 5/Alarme de Carro/Alarme de Carro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alarme_carro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alarme_carro.tcl
